    ...
    return (
      <div>
        <div>
          ...
          <p className="text-violet-600 text-center font-semibold text-xl max-w-[500px] mx-auto mb-10">Here is all the category book we have. You can see category base book by clicking on those card.</p>
        </div>
